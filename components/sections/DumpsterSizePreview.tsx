...
const dumpsters = [
  {
    ...
    idealFor: ["Home Cleanouts", "Roofing Projects", "Small Renovations", "Yard Waste"],
  ...
  },
  {
    ...
    rental: "7-10 day rental included",
    idealFor: ["Concrete & Dirt", "Asphalt", "Rock & Gravel", "Heavy Materials"],
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-ssws-steel">
            Three sizes to fit every job — from small cleanouts to major construction.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {dumpsters.map((d) => (
            ...
            >
              ...
              {/* Dumpster image placeholder — swap with next/image when client photos arrive */}
              <div className="bg-gradient-to-br from-ssws-navy to-ssws-blue h-36 flex flex-col items-center justify-center border-b border-gray-100 gap-2 relative overflow-hidden">
